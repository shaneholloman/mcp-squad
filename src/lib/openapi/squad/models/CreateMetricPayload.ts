...
export type CreateMetricPayloadTypeEnum =
  (typeof CreateMetricPayloadTypeEnum)[keyof typeof CreateMetricPayloadTypeEnum];
...
export type CreateMetricPayloadTargetOperatorEnum =
  (typeof CreateMetricPayloadTargetOperatorEnum)[keyof typeof CreateMetricPayloadTargetOperatorEnum];
...
export type CreateMetricPayloadTargetDirectionEnum =
  (typeof CreateMetricPayloadTargetDirectionEnum)[keyof typeof CreateMetricPayloadTargetDirectionEnum];
...
export type CreateMetricPayloadPeriodTypeEnum =
  (typeof CreateMetricPayloadPeriodTypeEnum)[keyof typeof CreateMetricPayloadPeriodTypeEnum];
...
export type CreateMetricPayloadPeriodValueEnum =
  (typeof CreateMetricPayloadPeriodValueEnum)[keyof typeof CreateMetricPayloadPeriodValueEnum];

/**
 * Check if a given object implements the CreateMetricPayload interface.
 */
export function instanceOfCreateMetricPayload(
  value: object,
): value is CreateMetricPayload {
...
export function CreateMetricPayloadFromJSONTyped(
  json: any,
  ...
  return {
    ...
    targetOperator:
      json["targetOperator"] == null ? undefined : json["targetOperator"],
    targetValue: json["targetValue"] == null ? undefined : json["targetValue"],
    targetDirection:
      json["targetDirection"] == null ? undefined : json["targetDirection"],
    currentValue:
      json["currentValue"] == null ? undefined : json["currentValue"],
    previousValue:
      json["previousValue"] == null ? undefined : json["previousValue"],
    periodType: json["periodType"] == null ? undefined : json["periodType"],
    periodValue: json["periodValue"] == null ? undefined : json["periodValue"],
    timeseries:
      json["timeseries"] == null
        ? undefined
        : (json["timeseries"] as Array<any>).map(MetricTimeseriesPointFromJSON),
    relatedOutcomes:
      json["relatedOutcomes"] == null ? undefined : json["relatedOutcomes"],
    id:
      json["id"] == null
        ? undefined
        : CreateMetricPayloadIdFromJSON(json["id"]),
...
export function CreateMetricPayloadToJSONTyped(
  value?: CreateMetricPayload | null,
  ...
  return {
    ...
    timeseries:
      value["timeseries"] == null
        ? undefined
        : (value["timeseries"] as Array<any>).map(MetricTimeseriesPointToJSON),
