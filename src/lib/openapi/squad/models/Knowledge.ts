...
export type KnowledgeStateEnum =
  (typeof KnowledgeStateEnum)[keyof typeof KnowledgeStateEnum];
...
export type KnowledgeSourceEnum =
  (typeof KnowledgeSourceEnum)[keyof typeof KnowledgeSourceEnum];
...
export function KnowledgeFromJSONTyped(
  json: any,
...
export function KnowledgeToJSONTyped(
