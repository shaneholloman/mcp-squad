...
export type CreateInsightRequestTypeEnum =
  (typeof CreateInsightRequestTypeEnum)[keyof typeof CreateInsightRequestTypeEnum];

/**
 * Check if a given object implements the CreateInsightRequest interface.
 */
export function instanceOfCreateInsightRequest(
  value: object,
): value is CreateInsightRequest {
...
export function CreateInsightRequestFromJSONTyped(
  json: any,
...
export function CreateInsightRequestToJSONTyped(
  value?: CreateInsightRequest | null,
