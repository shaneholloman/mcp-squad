...
export type GetOrganisationStatus200ResponseDataStatusEnum =
  (typeof GetOrganisationStatus200ResponseDataStatusEnum)[keyof typeof GetOrganisationStatus200ResponseDataStatusEnum];

/**
 * Check if a given object implements the GetOrganisationStatus200ResponseData interface.
 */
export function instanceOfGetOrganisationStatus200ResponseData(
  value: object,
): value is GetOrganisationStatus200ResponseData {
  ...
  if (
    !("hasRemainingCredits" in value) ||
    value["hasRemainingCredits"] === undefined
  )
    return false;
  if (
    !("billingCycleCreditAllowance" in value) ||
    value["billingCycleCreditAllowance"] === undefined
  )
    return false;
  if (
    !("billingCycleCreditUsage" in value) ||
    value["billingCycleCreditUsage"] === undefined
  )
    return false;
  if (
    !("billingCycleFlexCreditUsage" in value) ||
    value["billingCycleFlexCreditUsage"] === undefined
  )
    return false;
  if (
    !("currentBillingCycleStartDate" in value) ||
    value["currentBillingCycleStartDate"] === undefined
  )
    return false;
  if (
    !("currentBillingCycleEndDate" in value) ||
    value["currentBillingCycleEndDate"] === undefined
  )
    return false;
...
export function GetOrganisationStatus200ResponseDataFromJSON(
  json: any,
): GetOrganisationStatus200ResponseData {
  return GetOrganisationStatus200ResponseDataFromJSONTyped(json, false);
}

export function GetOrganisationStatus200ResponseDataFromJSONTyped(
  json: any,
  ...
  return {
    ...
    logoUrl:
      json["logoUrl"] == null
        ? undefined
        : CreateOrganisation200ResponseDataLogoUrlFromJSON(json["logoUrl"]),
...
export function GetOrganisationStatus200ResponseDataToJSON(
  json: any,
): GetOrganisationStatus200ResponseData {
  return GetOrganisationStatus200ResponseDataToJSONTyped(json, false);
}

export function GetOrganisationStatus200ResponseDataToJSONTyped(
  value?: GetOrganisationStatus200ResponseData | null,
  ...
  return {
    ...
    homepageUrl: CreateOrganisation200ResponseDataHomepageUrlToJSON(
      value["homepageUrl"],
    ),
