...
export type CreateRequirementAiProcessingStateEnum =
  (typeof CreateRequirementAiProcessingStateEnum)[keyof typeof CreateRequirementAiProcessingStateEnum];
...
export type CreateRequirementStatusEnum =
  (typeof CreateRequirementStatusEnum)[keyof typeof CreateRequirementStatusEnum];

/**
 * Check if a given object implements the CreateRequirement interface.
 */
export function instanceOfCreateRequirement(
  value: object,
): value is CreateRequirement {
  if (
...
export function CreateRequirementFromJSONTyped(
  json: any,
...
export function CreateRequirementToJSONTyped(
  value?: CreateRequirement | null,
