 ...
 */
export function instanceOfSimilaritySearchResponse(
  value: object,
): value is SimilaritySearchResponse {
  return true;
}

export function SimilaritySearchResponseFromJSON(
  json: any,
): SimilaritySearchResponse {
  return SimilaritySearchResponseFromJSONTyped(json, false);
}

export function SimilaritySearchResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...json,
    opportunities:
      json["opportunities"] == null
        ? undefined
        : (json["opportunities"] as Array<any>).map(
            SimilaritySearchResponseOpportunitiesInnerFromJSON,
          ),
    knowledge:
      json["knowledge"] == null
        ? undefined
        : (json["knowledge"] as Array<any>).map(
            SimilaritySearchResponseKnowledgeInnerFromJSON,
          ),
    insights:
      json["insights"] == null
        ? undefined
        : (json["insights"] as Array<any>).map(
            SimilaritySearchResponseInsightsInnerFromJSON,
          ),
    solutions:
      json["solutions"] == null
        ? undefined
        : (json["solutions"] as Array<any>).map(
            SimilaritySearchResponseSolutionsInnerFromJSON,
          ),
    totalResults:
      json["totalResults"] == null ? undefined : json["totalResults"],
  };
}

export function SimilaritySearchResponseToJSON(
  json: any,
): SimilaritySearchResponse {
  return SimilaritySearchResponseToJSONTyped(json, false);
}

export function SimilaritySearchResponseToJSONTyped(
  value?: SimilaritySearchResponse | null,
  ...
  return {
    ...
    opportunities:
      value["opportunities"] == null
        ? undefined
        : (value["opportunities"] as Array<any>).map(
            SimilaritySearchResponseOpportunitiesInnerToJSON,
          ),
    knowledge:
      value["knowledge"] == null
        ? undefined
        : (value["knowledge"] as Array<any>).map(
            SimilaritySearchResponseKnowledgeInnerToJSON,
          ),
    insights:
      value["insights"] == null
        ? undefined
        : (value["insights"] as Array<any>).map(
            SimilaritySearchResponseInsightsInnerToJSON,
          ),
    solutions:
      value["solutions"] == null
        ? undefined
        : (value["solutions"] as Array<any>).map(
            SimilaritySearchResponseSolutionsInnerToJSON,
          ),
