...
export type UpdateMetricPayloadTypeEnum =
  (typeof UpdateMetricPayloadTypeEnum)[keyof typeof UpdateMetricPayloadTypeEnum];
...
export type UpdateMetricPayloadTargetOperatorEnum =
  (typeof UpdateMetricPayloadTargetOperatorEnum)[keyof typeof UpdateMetricPayloadTargetOperatorEnum];
...
export type UpdateMetricPayloadTargetDirectionEnum =
  (typeof UpdateMetricPayloadTargetDirectionEnum)[keyof typeof UpdateMetricPayloadTargetDirectionEnum];
...
export type UpdateMetricPayloadPeriodTypeEnum =
  (typeof UpdateMetricPayloadPeriodTypeEnum)[keyof typeof UpdateMetricPayloadPeriodTypeEnum];
...
export type UpdateMetricPayloadPeriodValueEnum =
  (typeof UpdateMetricPayloadPeriodValueEnum)[keyof typeof UpdateMetricPayloadPeriodValueEnum];

/**
 * Check if a given object implements the UpdateMetricPayload interface.
 */
export function instanceOfUpdateMetricPayload(
  value: object,
): value is UpdateMetricPayload {
  return true;
}
...
export function UpdateMetricPayloadFromJSONTyped(
  json: any,
...
export function UpdateMetricPayloadToJSONTyped(
  value?: UpdateMetricPayload | null,
