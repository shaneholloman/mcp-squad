 ...
 */
export function instanceOfMetricTimeseriesPoint(
  value: object,
...
export function MetricTimeseriesPointFromJSON(
  json: any,
): MetricTimeseriesPoint {
  return MetricTimeseriesPointFromJSONTyped(json, false);
}

export function MetricTimeseriesPointFromJSONTyped(
  json: any,
...
export function MetricTimeseriesPointToJSONTyped(
  value?: MetricTimeseriesPoint | null,
