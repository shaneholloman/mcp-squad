 ...
 */
export function instanceOfCreateFeedbackDocumentResponseData(
  value: object,
): value is CreateFeedbackDocumentResponseData {
  if (!("uploadUrl" in value) || value["uploadUrl"] === undefined) return false;
  return true;
}

export function CreateFeedbackDocumentResponseDataFromJSON(
  json: any,
): CreateFeedbackDocumentResponseData {
  return CreateFeedbackDocumentResponseDataFromJSONTyped(json, false);
}

export function CreateFeedbackDocumentResponseDataFromJSONTyped(
  json: any,
...
export function CreateFeedbackDocumentResponseDataToJSON(
  json: any,
): CreateFeedbackDocumentResponseData {
  return CreateFeedbackDocumentResponseDataToJSONTyped(json, false);
}

export function CreateFeedbackDocumentResponseDataToJSONTyped(
  value?: CreateFeedbackDocumentResponseData | null,
