 ...
 */
export function instanceOfCreateIntegration200Response(
  value: object,
): value is CreateIntegration200Response {
  if (!("data" in value) || value["data"] === undefined) return false;
  return true;
}

export function CreateIntegration200ResponseFromJSON(
  json: any,
): CreateIntegration200Response {
  return CreateIntegration200ResponseFromJSONTyped(json, false);
}

export function CreateIntegration200ResponseFromJSONTyped(
  json: any,
...
export function CreateIntegration200ResponseToJSON(
  json: any,
): CreateIntegration200Response {
  return CreateIntegration200ResponseToJSONTyped(json, false);
}

export function CreateIntegration200ResponseToJSONTyped(
  value?: CreateIntegration200Response | null,
