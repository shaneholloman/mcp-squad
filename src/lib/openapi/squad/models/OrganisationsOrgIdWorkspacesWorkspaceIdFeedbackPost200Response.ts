 ...
 */
export function instanceOfOrganisationsOrgIdWorkspacesWorkspaceIdFeedbackPost200Response(
  value: object,
): value is OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackPost200Response {
  if (!("data" in value) || value["data"] === undefined) return false;
  return true;
}

export function OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackPost200ResponseFromJSON(
  json: any,
): OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackPost200Response {
  return OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackPost200ResponseFromJSONTyped(
    json,
    false,
  );
}

export function OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackPost200ResponseFromJSONTyped(
  json: any,
...
export function OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackPost200ResponseToJSON(
  json: any,
): OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackPost200Response {
  return OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackPost200ResponseToJSONTyped(
    json,
    false,
  );
}

export function OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackPost200ResponseToJSONTyped(
  value?: OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackPost200Response | null,
