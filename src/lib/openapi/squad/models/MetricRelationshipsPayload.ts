 ...
 */
export function instanceOfMetricRelationshipsPayload(
  value: object,
): value is MetricRelationshipsPayload {
  return true;
}

export function MetricRelationshipsPayloadFromJSON(
  json: any,
): MetricRelationshipsPayload {
  return MetricRelationshipsPayloadFromJSONTyped(json, false);
}

export function MetricRelationshipsPayloadFromJSONTyped(
  json: any,
...
export function MetricRelationshipsPayloadToJSON(
  json: any,
): MetricRelationshipsPayload {
  return MetricRelationshipsPayloadToJSONTyped(json, false);
}

export function MetricRelationshipsPayloadToJSONTyped(
  value?: MetricRelationshipsPayload | null,
