 ...
 */
export function instanceOfCreateFeedbackDocumentPayload(
  value: object,
): value is CreateFeedbackDocumentPayload {
  if (!("fileName" in value) || value["fileName"] === undefined) return false;
  return true;
}

export function CreateFeedbackDocumentPayloadFromJSON(
  json: any,
): CreateFeedbackDocumentPayload {
  return CreateFeedbackDocumentPayloadFromJSONTyped(json, false);
}

export function CreateFeedbackDocumentPayloadFromJSONTyped(
  json: any,
...
export function CreateFeedbackDocumentPayloadToJSON(
  json: any,
): CreateFeedbackDocumentPayload {
  return CreateFeedbackDocumentPayloadToJSONTyped(json, false);
}

export function CreateFeedbackDocumentPayloadToJSONTyped(
  value?: CreateFeedbackDocumentPayload | null,
