 ...
 */
export function instanceOfRequirementRelationshipsPayload(
  value: object,
): value is RequirementRelationshipsPayload {
  return true;
}

export function RequirementRelationshipsPayloadFromJSON(
  json: any,
): RequirementRelationshipsPayload {
  return RequirementRelationshipsPayloadFromJSONTyped(json, false);
}

export function RequirementRelationshipsPayloadFromJSONTyped(
  json: any,
...
export function RequirementRelationshipsPayloadToJSON(
  json: any,
): RequirementRelationshipsPayload {
  return RequirementRelationshipsPayloadToJSONTyped(json, false);
}

export function RequirementRelationshipsPayloadToJSONTyped(
  value?: RequirementRelationshipsPayload | null,
