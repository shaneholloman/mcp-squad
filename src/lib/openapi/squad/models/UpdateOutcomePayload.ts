 ...
 */
export function instanceOfUpdateOutcomePayload(
  value: object,
): value is UpdateOutcomePayload {
  return true;
}
...
export function UpdateOutcomePayloadFromJSONTyped(
  json: any,
...
export function UpdateOutcomePayloadToJSONTyped(
  value?: UpdateOutcomePayload | null,
