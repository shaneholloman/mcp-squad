...
export type SingleKnowledgeResponseWithUploadPdfStateEnum =
  (typeof SingleKnowledgeResponseWithUploadPdfStateEnum)[keyof typeof SingleKnowledgeResponseWithUploadPdfStateEnum];
...
export type SingleKnowledgeResponseWithUploadPdfSourceEnum =
  (typeof SingleKnowledgeResponseWithUploadPdfSourceEnum)[keyof typeof SingleKnowledgeResponseWithUploadPdfSourceEnum];

/**
 * Check if a given object implements the SingleKnowledgeResponseWithUploadPdf interface.
 */
export function instanceOfSingleKnowledgeResponseWithUploadPdf(
  value: object,
): value is SingleKnowledgeResponseWithUploadPdf {
...
export function SingleKnowledgeResponseWithUploadPdfFromJSON(
  json: any,
): SingleKnowledgeResponseWithUploadPdf {
  return SingleKnowledgeResponseWithUploadPdfFromJSONTyped(json, false);
}

export function SingleKnowledgeResponseWithUploadPdfFromJSONTyped(
  json: any,
...
export function SingleKnowledgeResponseWithUploadPdfToJSON(
  json: any,
): SingleKnowledgeResponseWithUploadPdf {
  return SingleKnowledgeResponseWithUploadPdfToJSONTyped(json, false);
}

export function SingleKnowledgeResponseWithUploadPdfToJSONTyped(
  value?: SingleKnowledgeResponseWithUploadPdf | null,
