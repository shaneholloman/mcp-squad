 ...
 */
export function instanceOfOpportunityArrayResponse(
  value: object,
): value is OpportunityArrayResponse {
  if (!("data" in value) || value["data"] === undefined) return false;
  return true;
}

export function OpportunityArrayResponseFromJSON(
  json: any,
): OpportunityArrayResponse {
  return OpportunityArrayResponseFromJSONTyped(json, false);
}

export function OpportunityArrayResponseFromJSONTyped(
  json: any,
...
export function OpportunityArrayResponseToJSON(
  json: any,
): OpportunityArrayResponse {
  return OpportunityArrayResponseToJSONTyped(json, false);
}

export function OpportunityArrayResponseToJSONTyped(
  value?: OpportunityArrayResponse | null,
