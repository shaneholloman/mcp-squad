...
export type SolutionAiProcessingStateEnum =
  (typeof SolutionAiProcessingStateEnum)[keyof typeof SolutionAiProcessingStateEnum];
...
export type SolutionStatusEnum =
  (typeof SolutionStatusEnum)[keyof typeof SolutionStatusEnum];
...
export type SolutionCreatedByEnum =
  (typeof SolutionCreatedByEnum)[keyof typeof SolutionCreatedByEnum];
...
export type SolutionHorizonEnum =
  (typeof SolutionHorizonEnum)[keyof typeof SolutionHorizonEnum];
...
export function SolutionFromJSONTyped(
  json: any,
...
export function SolutionToJSONTyped(
  value?: Solution | null,
