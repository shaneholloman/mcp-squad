...
export type OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsGet200ResponseDataInnerAiProcessingStateEnum = typeof OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsGet200ResponseDataInnerAiProcessingStateEnum[keyof typeof OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsGet200ResponseDataInnerAiProcessingStateEnum];
...
export type OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsGet200ResponseDataInnerStatusEnum = typeof OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsGet200ResponseDataInnerStatusEnum[keyof typeof OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsGet200ResponseDataInnerStatusEnum];
 ...
 */
export function instanceOfOrganisationsOrgIdWorkspacesWorkspaceIdRequirementsGet200ResponseDataInner(value: object): value is OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsGet200ResponseDataInner {
...
export function OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsGet200ResponseDataInnerFromJSON(json: any): OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsGet200ResponseDataInner {
    return OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsGet200ResponseDataInnerFromJSONTyped(json, false);
}

export function OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsGet200ResponseDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsGet200ResponseDataInner {
    if (json == null) {
        return json;
    }
    return {
...
export function OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsGet200ResponseDataInnerToJSON(json: any): OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsGet200ResponseDataInner {
    return OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsGet200ResponseDataInnerToJSONTyped(json, false);
}

export function OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsGet200ResponseDataInnerToJSONTyped(value?: OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsGet200ResponseDataInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
