...
export type UpdateSolutionPayloadAiProcessingStateEnum =
  (typeof UpdateSolutionPayloadAiProcessingStateEnum)[keyof typeof UpdateSolutionPayloadAiProcessingStateEnum];
...
export type UpdateSolutionPayloadStatusEnum =
  (typeof UpdateSolutionPayloadStatusEnum)[keyof typeof UpdateSolutionPayloadStatusEnum];
...
export type UpdateSolutionPayloadHorizonEnum =
  (typeof UpdateSolutionPayloadHorizonEnum)[keyof typeof UpdateSolutionPayloadHorizonEnum];
...
export type UpdateSolutionPayloadUpdateTriggeredByEnum =
  (typeof UpdateSolutionPayloadUpdateTriggeredByEnum)[keyof typeof UpdateSolutionPayloadUpdateTriggeredByEnum];

/**
 * Check if a given object implements the UpdateSolutionPayload interface.
 */
export function instanceOfUpdateSolutionPayload(
  value: object,
): value is UpdateSolutionPayload {
  return true;
}

export function UpdateSolutionPayloadFromJSON(
  json: any,
): UpdateSolutionPayload {
  return UpdateSolutionPayloadFromJSONTyped(json, false);
}

export function UpdateSolutionPayloadFromJSONTyped(
  json: any,
  ...
  return {
    ...
    updateTriggeredBy:
      json["updateTriggeredBy"] == null ? undefined : json["updateTriggeredBy"],
  };
}
...
export function UpdateSolutionPayloadToJSONTyped(
  value?: UpdateSolutionPayload | null,
