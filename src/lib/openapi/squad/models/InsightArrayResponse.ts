 ...
 */
export function instanceOfInsightArrayResponse(
  value: object,
): value is InsightArrayResponse {
...
export function InsightArrayResponseFromJSONTyped(
  json: any,
...
export function InsightArrayResponseToJSONTyped(
  value?: InsightArrayResponse | null,
