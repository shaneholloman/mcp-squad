 ...
 */
export function instanceOfOrganisationsOrgIdPutRequest(
  value: object,
): value is OrganisationsOrgIdPutRequest {
  return true;
}

export function OrganisationsOrgIdPutRequestFromJSON(
  json: any,
): OrganisationsOrgIdPutRequest {
  return OrganisationsOrgIdPutRequestFromJSONTyped(json, false);
}

export function OrganisationsOrgIdPutRequestFromJSONTyped(
  json: any,
...
export function OrganisationsOrgIdPutRequestToJSON(
  json: any,
): OrganisationsOrgIdPutRequest {
  return OrganisationsOrgIdPutRequestToJSONTyped(json, false);
}

export function OrganisationsOrgIdPutRequestToJSONTyped(
  value?: OrganisationsOrgIdPutRequest | null,
