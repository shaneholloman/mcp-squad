 ...
 */
export function instanceOfNotionResponseConfig(
  value: object,
): value is NotionResponseConfig {
...
export function NotionResponseConfigFromJSONTyped(
  json: any,
...
export function NotionResponseConfigToJSONTyped(
  value?: NotionResponseConfig | null,
  ...
  return {
    ...
    last_synced_at:
      value["lastSyncedAt"] == null
        ? undefined
        : (value["lastSyncedAt"] as any).toISOString(),
  };
}
