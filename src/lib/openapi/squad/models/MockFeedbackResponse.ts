...
export interface MockFeedbackResponse
  extends Array<MockFeedbackResponseInner> {}

/**
 * Check if a given object implements the MockFeedbackResponse interface.
 */
export function instanceOfMockFeedbackResponse(
  value: object,
): value is MockFeedbackResponse {
  return true;
}
...
export function MockFeedbackResponseFromJSONTyped(
  json: any,
...
export function MockFeedbackResponseToJSONTyped(
  value?: MockFeedbackResponse | null,
