 ...
 */
export function instanceOfTrackTokenUsageRequest(
  value: object,
): value is TrackTokenUsageRequest {
...
export function TrackTokenUsageRequestFromJSON(
  json: any,
): TrackTokenUsageRequest {
  return TrackTokenUsageRequestFromJSONTyped(json, false);
}

export function TrackTokenUsageRequestFromJSONTyped(
  json: any,
...
export function TrackTokenUsageRequestToJSON(
  json: any,
): TrackTokenUsageRequest {
  return TrackTokenUsageRequestToJSONTyped(json, false);
}

export function TrackTokenUsageRequestToJSONTyped(
  value?: TrackTokenUsageRequest | null,
