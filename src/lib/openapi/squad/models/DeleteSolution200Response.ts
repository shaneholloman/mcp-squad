 ...
 */
export function instanceOfDeleteSolution200Response(
  value: object,
): value is DeleteSolution200Response {
  if (!("data" in value) || value["data"] === undefined) return false;
  return true;
}

export function DeleteSolution200ResponseFromJSON(
  json: any,
): DeleteSolution200Response {
  return DeleteSolution200ResponseFromJSONTyped(json, false);
}

export function DeleteSolution200ResponseFromJSONTyped(
  json: any,
...
export function DeleteSolution200ResponseToJSON(
  json: any,
): DeleteSolution200Response {
  return DeleteSolution200ResponseToJSONTyped(json, false);
}

export function DeleteSolution200ResponseToJSONTyped(
  value?: DeleteSolution200Response | null,
