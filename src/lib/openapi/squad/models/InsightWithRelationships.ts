...
export type InsightWithRelationshipsTypeEnum =
  (typeof InsightWithRelationshipsTypeEnum)[keyof typeof InsightWithRelationshipsTypeEnum];

/**
 * Check if a given object implements the InsightWithRelationships interface.
 */
export function instanceOfInsightWithRelationships(
  value: object,
): value is InsightWithRelationships {
...
export function InsightWithRelationshipsFromJSON(
  json: any,
): InsightWithRelationships {
  return InsightWithRelationshipsFromJSONTyped(json, false);
}

export function InsightWithRelationshipsFromJSONTyped(
  json: any,
  ...
  return {
    ...
    strengthScore:
      json["strengthScore"] == null ? undefined : json["strengthScore"],
    momentumScore:
      json["momentumScore"] == null ? undefined : json["momentumScore"],
    combinedScore:
      json["combinedScore"] == null ? undefined : json["combinedScore"],
    lastScoreCalculatedAt:
      json["lastScoreCalculatedAt"] == null
        ? undefined
        : new Date(json["lastScoreCalculatedAt"]),
    topicEmbeddings:
      json["topicEmbeddings"] == null ? undefined : json["topicEmbeddings"],
...
export function InsightWithRelationshipsToJSON(
  json: any,
): InsightWithRelationships {
  return InsightWithRelationshipsToJSONTyped(json, false);
}

export function InsightWithRelationshipsToJSONTyped(
  value?: InsightWithRelationships | null,
  ...
  return {
    ...
    lastScoreCalculatedAt:
      value["lastScoreCalculatedAt"] == null
        ? undefined
        : value["lastScoreCalculatedAt"].toISOString(),
