...
import { OpportunityFromJSON, OpportunityToJSON } from "./Opportunity.js";
...
export type SolutionWithRelationshipsAiProcessingStateEnum =
  (typeof SolutionWithRelationshipsAiProcessingStateEnum)[keyof typeof SolutionWithRelationshipsAiProcessingStateEnum];
...
export type SolutionWithRelationshipsStatusEnum =
  (typeof SolutionWithRelationshipsStatusEnum)[keyof typeof SolutionWithRelationshipsStatusEnum];
...
export type SolutionWithRelationshipsCreatedByEnum =
  (typeof SolutionWithRelationshipsCreatedByEnum)[keyof typeof SolutionWithRelationshipsCreatedByEnum];
...
export type SolutionWithRelationshipsHorizonEnum =
  (typeof SolutionWithRelationshipsHorizonEnum)[keyof typeof SolutionWithRelationshipsHorizonEnum];

/**
 * Check if a given object implements the SolutionWithRelationships interface.
 */
export function instanceOfSolutionWithRelationships(
  value: object,
): value is SolutionWithRelationships {
  ...
  if (!("opportunities" in value) || value["opportunities"] === undefined)
    return false;
...
export function SolutionWithRelationshipsFromJSON(
  json: any,
): SolutionWithRelationships {
  return SolutionWithRelationshipsFromJSONTyped(json, false);
}

export function SolutionWithRelationshipsFromJSONTyped(
  json: any,
  ...
  return {
    ...
    opportunities: (json["opportunities"] as Array<any>).map(
      OpportunityFromJSON,
    ),
...
export function SolutionWithRelationshipsToJSON(
  json: any,
): SolutionWithRelationships {
  return SolutionWithRelationshipsToJSONTyped(json, false);
}

export function SolutionWithRelationshipsToJSONTyped(
  value?: SolutionWithRelationships | null,
  ...
  return {
    ...
    opportunities: (value["opportunities"] as Array<any>).map(
      OpportunityToJSON,
    ),
