 ...
 */
export function instanceOfOrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGet200ResponseInner(
  value: object,
): value is OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGet200ResponseInner {
...
export function OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGet200ResponseInnerFromJSON(
  json: any,
): OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGet200ResponseInner {
  return OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGet200ResponseInnerFromJSONTyped(
    json,
    false,
  );
}

export function OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGet200ResponseInnerFromJSONTyped(
  json: any,
...
export function OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGet200ResponseInnerToJSON(
  json: any,
): OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGet200ResponseInner {
  return OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGet200ResponseInnerToJSONTyped(
    json,
    false,
  );
}

export function OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGet200ResponseInnerToJSONTyped(
  value?: OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGet200ResponseInner | null,
