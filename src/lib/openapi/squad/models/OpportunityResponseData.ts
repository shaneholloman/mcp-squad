...
export type OpportunityResponseDataStatusEnum =
  (typeof OpportunityResponseDataStatusEnum)[keyof typeof OpportunityResponseDataStatusEnum];
...
export type OpportunityResponseDataSolutionsGeneratingStateEnum =
  (typeof OpportunityResponseDataSolutionsGeneratingStateEnum)[keyof typeof OpportunityResponseDataSolutionsGeneratingStateEnum];
...
export type OpportunityResponseDataCreatedByEnum =
  (typeof OpportunityResponseDataCreatedByEnum)[keyof typeof OpportunityResponseDataCreatedByEnum];

/**
 * Check if a given object implements the OpportunityResponseData interface.
 */
export function instanceOfOpportunityResponseData(
  value: object,
): value is OpportunityResponseData {
...
export function OpportunityResponseDataFromJSON(
  json: any,
): OpportunityResponseData {
  return OpportunityResponseDataFromJSONTyped(json, false);
}

export function OpportunityResponseDataFromJSONTyped(
  json: any,
...
export function OpportunityResponseDataToJSON(
  json: any,
): OpportunityResponseData {
  return OpportunityResponseDataToJSONTyped(json, false);
}

export function OpportunityResponseDataToJSONTyped(
  value?: OpportunityResponseData | null,
