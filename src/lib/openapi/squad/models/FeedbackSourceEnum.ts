...
export type FeedbackSourceEnum =
  (typeof FeedbackSourceEnum)[keyof typeof FeedbackSourceEnum];
...
export function instanceOfFeedbackSourceEnum(value: any): boolean {
  for (const key in FeedbackSourceEnum) {
    if (Object.prototype.hasOwnProperty.call(FeedbackSourceEnum, key)) {
      if (
        FeedbackSourceEnum[key as keyof typeof FeedbackSourceEnum] === value
      ) {
        return true;
      }
    }
...
export function FeedbackSourceEnumFromJSONTyped(
  json: any,
...
export function FeedbackSourceEnumToJSON(
  value?: FeedbackSourceEnum | null,
): any {
  return value as any;
}

export function FeedbackSourceEnumToJSONTyped(
  value: any,
  ignoreDiscriminator: boolean,
): FeedbackSourceEnum {
