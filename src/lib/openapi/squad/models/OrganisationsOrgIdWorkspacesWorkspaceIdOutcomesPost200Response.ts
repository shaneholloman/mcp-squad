 ...
 */
export function instanceOfOrganisationsOrgIdWorkspacesWorkspaceIdOutcomesPost200Response(
  value: object,
): value is OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesPost200Response {
  if (!("data" in value) || value["data"] === undefined) return false;
  return true;
}

export function OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesPost200ResponseFromJSON(
  json: any,
): OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesPost200Response {
  return OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesPost200ResponseFromJSONTyped(
    json,
    false,
  );
}

export function OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesPost200ResponseFromJSONTyped(
  json: any,
...
export function OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesPost200ResponseToJSON(
  json: any,
): OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesPost200Response {
  return OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesPost200ResponseToJSONTyped(
    json,
    false,
  );
}

export function OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesPost200ResponseToJSONTyped(
  value?: OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesPost200Response | null,
