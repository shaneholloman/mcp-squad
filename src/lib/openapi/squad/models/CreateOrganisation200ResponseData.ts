...
export type CreateOrganisation200ResponseDataStatusEnum =
  (typeof CreateOrganisation200ResponseDataStatusEnum)[keyof typeof CreateOrganisation200ResponseDataStatusEnum];

/**
 * Check if a given object implements the CreateOrganisation200ResponseData interface.
 */
export function instanceOfCreateOrganisation200ResponseData(
  value: object,
): value is CreateOrganisation200ResponseData {
...
export function CreateOrganisation200ResponseDataFromJSON(
  json: any,
): CreateOrganisation200ResponseData {
  return CreateOrganisation200ResponseDataFromJSONTyped(json, false);
}

export function CreateOrganisation200ResponseDataFromJSONTyped(
  json: any,
...
export function CreateOrganisation200ResponseDataToJSON(
  json: any,
): CreateOrganisation200ResponseData {
  return CreateOrganisation200ResponseDataToJSONTyped(json, false);
}

export function CreateOrganisation200ResponseDataToJSONTyped(
  value?: CreateOrganisation200ResponseData | null,
