 ...
 */
export function instanceOfOnboardPost200ResponseOutcomesInner(value: object): value is OnboardPost200ResponseOutcomesInner {
...
export function OnboardPost200ResponseOutcomesInnerFromJSON(json: any): OnboardPost200ResponseOutcomesInner {
    return OnboardPost200ResponseOutcomesInnerFromJSONTyped(json, false);
}

export function OnboardPost200ResponseOutcomesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): OnboardPost200ResponseOutcomesInner {
    if (json == null) {
        return json;
    }
    return {
...
export function OnboardPost200ResponseOutcomesInnerToJSON(json: any): OnboardPost200ResponseOutcomesInner {
    return OnboardPost200ResponseOutcomesInnerToJSONTyped(json, false);
}

export function OnboardPost200ResponseOutcomesInnerToJSONTyped(value?: OnboardPost200ResponseOutcomesInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
