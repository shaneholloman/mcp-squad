...
export type CreateSolutionPayloadAiProcessingStateEnum =
  (typeof CreateSolutionPayloadAiProcessingStateEnum)[keyof typeof CreateSolutionPayloadAiProcessingStateEnum];
...
export type CreateSolutionPayloadStatusEnum =
  (typeof CreateSolutionPayloadStatusEnum)[keyof typeof CreateSolutionPayloadStatusEnum];
...
export type CreateSolutionPayloadCreatedByEnum =
  (typeof CreateSolutionPayloadCreatedByEnum)[keyof typeof CreateSolutionPayloadCreatedByEnum];
...
export type CreateSolutionPayloadHorizonEnum =
  (typeof CreateSolutionPayloadHorizonEnum)[keyof typeof CreateSolutionPayloadHorizonEnum];

/**
 * Check if a given object implements the CreateSolutionPayload interface.
 */
export function instanceOfCreateSolutionPayload(
  value: object,
): value is CreateSolutionPayload {
...
export function CreateSolutionPayloadFromJSON(
  json: any,
): CreateSolutionPayload {
  return CreateSolutionPayloadFromJSONTyped(json, false);
}

export function CreateSolutionPayloadFromJSONTyped(
  json: any,
...
export function CreateSolutionPayloadToJSONTyped(
  value?: CreateSolutionPayload | null,
