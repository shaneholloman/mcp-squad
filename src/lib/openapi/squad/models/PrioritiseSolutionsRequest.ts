...
export type PrioritiseSolutionsRequestTriggeredByEnum =
  (typeof PrioritiseSolutionsRequestTriggeredByEnum)[keyof typeof PrioritiseSolutionsRequestTriggeredByEnum];

/**
 * Check if a given object implements the PrioritiseSolutionsRequest interface.
 */
export function instanceOfPrioritiseSolutionsRequest(
  value: object,
): value is PrioritiseSolutionsRequest {
  if (!("beforeId" in value) || value["beforeId"] === undefined) return false;
  if (!("solutionIds" in value) || value["solutionIds"] === undefined)
    return false;
  return true;
}

export function PrioritiseSolutionsRequestFromJSON(
  json: any,
): PrioritiseSolutionsRequest {
  return PrioritiseSolutionsRequestFromJSONTyped(json, false);
}

export function PrioritiseSolutionsRequestFromJSONTyped(
  json: any,
...
export function PrioritiseSolutionsRequestToJSON(
  json: any,
): PrioritiseSolutionsRequest {
  return PrioritiseSolutionsRequestToJSONTyped(json, false);
}

export function PrioritiseSolutionsRequestToJSONTyped(
  value?: PrioritiseSolutionsRequest | null,
