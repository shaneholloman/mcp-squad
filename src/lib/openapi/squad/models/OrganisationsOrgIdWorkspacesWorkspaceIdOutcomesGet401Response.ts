 ...
 */
export function instanceOfOrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGet401Response(
  value: object,
): value is OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGet401Response {
  if (!("error" in value) || value["error"] === undefined) return false;
  return true;
}

export function OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGet401ResponseFromJSON(
  json: any,
): OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGet401Response {
  return OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGet401ResponseFromJSONTyped(
    json,
    false,
  );
}

export function OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGet401ResponseFromJSONTyped(
  json: any,
...
export function OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGet401ResponseToJSON(
  json: any,
): OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGet401Response {
  return OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGet401ResponseToJSONTyped(
    json,
    false,
  );
}

export function OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGet401ResponseToJSONTyped(
  value?: OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGet401Response | null,
