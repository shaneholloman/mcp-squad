...
export type ProfessionalOrganizationStatusSubscriptionTypeEnum =
  (typeof ProfessionalOrganizationStatusSubscriptionTypeEnum)[keyof typeof ProfessionalOrganizationStatusSubscriptionTypeEnum];
...
export type ProfessionalOrganizationStatusStatusEnum =
  (typeof ProfessionalOrganizationStatusStatusEnum)[keyof typeof ProfessionalOrganizationStatusStatusEnum];

/**
 * Check if a given object implements the ProfessionalOrganizationStatus interface.
 */
export function instanceOfProfessionalOrganizationStatus(
  value: object,
): value is ProfessionalOrganizationStatus {
...
export function ProfessionalOrganizationStatusFromJSON(
  json: any,
): ProfessionalOrganizationStatus {
  return ProfessionalOrganizationStatusFromJSONTyped(json, false);
}

export function ProfessionalOrganizationStatusFromJSONTyped(
  json: any,
...
export function ProfessionalOrganizationStatusToJSON(
  json: any,
): ProfessionalOrganizationStatus {
  return ProfessionalOrganizationStatusToJSONTyped(json, false);
}

export function ProfessionalOrganizationStatusToJSONTyped(
  value?: ProfessionalOrganizationStatus | null,
