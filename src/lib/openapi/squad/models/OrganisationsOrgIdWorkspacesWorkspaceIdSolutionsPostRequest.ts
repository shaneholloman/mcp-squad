...
export type OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRequestStatusEnum =
  (typeof OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRequestStatusEnum)[keyof typeof OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRequestStatusEnum];
...
export type OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRequestCreatedByEnum =
  (typeof OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRequestCreatedByEnum)[keyof typeof OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRequestCreatedByEnum];
...
export type OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRequestAiProcessingStateEnum =
  (typeof OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRequestAiProcessingStateEnum)[keyof typeof OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRequestAiProcessingStateEnum];

/**
 * Check if a given object implements the OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRequest interface.
 */
export function instanceOfOrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRequest(
  value: object,
): value is OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRequest {
...
export function OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRequestFromJSON(
  json: any,
): OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRequest {
  return OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRequestFromJSONTyped(
    json,
    false,
  );
}

export function OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRequestFromJSONTyped(
  json: any,
...
export function OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRequestToJSON(
  json: any,
): OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRequest {
  return OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRequestToJSONTyped(
    json,
    false,
  );
}

export function OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRequestToJSONTyped(
  value?: OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRequest | null,
