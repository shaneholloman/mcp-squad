 ...
 */
export function instanceOfCreateTopic200Response(
  value: object,
): value is CreateTopic200Response {
  if (!("data" in value) || value["data"] === undefined) return false;
  return true;
}

export function CreateTopic200ResponseFromJSON(
  json: any,
): CreateTopic200Response {
  return CreateTopic200ResponseFromJSONTyped(json, false);
}

export function CreateTopic200ResponseFromJSONTyped(
  json: any,
...
export function CreateTopic200ResponseToJSON(
  json: any,
): CreateTopic200Response {
  return CreateTopic200ResponseToJSONTyped(json, false);
}

export function CreateTopic200ResponseToJSONTyped(
  value?: CreateTopic200Response | null,
