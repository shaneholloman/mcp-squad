 ...
 */
export function instanceOfManageRequirementRelationshipsRequest(
  value: object,
): value is ManageRequirementRelationshipsRequest {
  return true;
}

export function ManageRequirementRelationshipsRequestFromJSON(
  json: any,
): ManageRequirementRelationshipsRequest {
  return ManageRequirementRelationshipsRequestFromJSONTyped(json, false);
}

export function ManageRequirementRelationshipsRequestFromJSONTyped(
  json: any,
...
export function ManageRequirementRelationshipsRequestToJSON(
  json: any,
): ManageRequirementRelationshipsRequest {
  return ManageRequirementRelationshipsRequestToJSONTyped(json, false);
}

export function ManageRequirementRelationshipsRequestToJSONTyped(
  value?: ManageRequirementRelationshipsRequest | null,
