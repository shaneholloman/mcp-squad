...
export type UpdateRequirementAiProcessingStateEnum =
  (typeof UpdateRequirementAiProcessingStateEnum)[keyof typeof UpdateRequirementAiProcessingStateEnum];
...
export type UpdateRequirementStatusEnum =
  (typeof UpdateRequirementStatusEnum)[keyof typeof UpdateRequirementStatusEnum];

/**
 * Check if a given object implements the UpdateRequirement interface.
 */
export function instanceOfUpdateRequirement(
  value: object,
): value is UpdateRequirement {
  return true;
}
...
export function UpdateRequirementFromJSONTyped(
  json: any,
...
export function UpdateRequirementToJSONTyped(
  value?: UpdateRequirement | null,
