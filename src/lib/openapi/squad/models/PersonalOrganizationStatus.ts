...
export type PersonalOrganizationStatusSubscriptionTypeEnum =
  (typeof PersonalOrganizationStatusSubscriptionTypeEnum)[keyof typeof PersonalOrganizationStatusSubscriptionTypeEnum];
...
export type PersonalOrganizationStatusStatusEnum =
  (typeof PersonalOrganizationStatusStatusEnum)[keyof typeof PersonalOrganizationStatusStatusEnum];

/**
 * Check if a given object implements the PersonalOrganizationStatus interface.
 */
export function instanceOfPersonalOrganizationStatus(
  value: object,
): value is PersonalOrganizationStatus {
...
export function PersonalOrganizationStatusFromJSON(
  json: any,
): PersonalOrganizationStatus {
  return PersonalOrganizationStatusFromJSONTyped(json, false);
}

export function PersonalOrganizationStatusFromJSONTyped(
  json: any,
...
export function PersonalOrganizationStatusToJSON(
  json: any,
): PersonalOrganizationStatus {
  return PersonalOrganizationStatusToJSONTyped(json, false);
}

export function PersonalOrganizationStatusToJSONTyped(
  value?: PersonalOrganizationStatus | null,
