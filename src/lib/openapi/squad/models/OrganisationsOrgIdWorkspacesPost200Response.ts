 ...
 */
export function instanceOfOrganisationsOrgIdWorkspacesPost200Response(
  value: object,
): value is OrganisationsOrgIdWorkspacesPost200Response {
  if (!("data" in value) || value["data"] === undefined) return false;
  return true;
}

export function OrganisationsOrgIdWorkspacesPost200ResponseFromJSON(
  json: any,
): OrganisationsOrgIdWorkspacesPost200Response {
  return OrganisationsOrgIdWorkspacesPost200ResponseFromJSONTyped(json, false);
}

export function OrganisationsOrgIdWorkspacesPost200ResponseFromJSONTyped(
  json: any,
...
export function OrganisationsOrgIdWorkspacesPost200ResponseToJSON(
  json: any,
): OrganisationsOrgIdWorkspacesPost200Response {
  return OrganisationsOrgIdWorkspacesPost200ResponseToJSONTyped(json, false);
}

export function OrganisationsOrgIdWorkspacesPost200ResponseToJSONTyped(
  value?: OrganisationsOrgIdWorkspacesPost200Response | null,
