 ...
 */
export function instanceOfCreateOpportunity429Response(
  value: object,
): value is CreateOpportunity429Response {
  if (!("error" in value) || value["error"] === undefined) return false;
  return true;
}

export function CreateOpportunity429ResponseFromJSON(
  json: any,
): CreateOpportunity429Response {
  return CreateOpportunity429ResponseFromJSONTyped(json, false);
}

export function CreateOpportunity429ResponseFromJSONTyped(
  json: any,
...
export function CreateOpportunity429ResponseToJSON(
  json: any,
): CreateOpportunity429Response {
  return CreateOpportunity429ResponseToJSONTyped(json, false);
}

export function CreateOpportunity429ResponseToJSONTyped(
  value?: CreateOpportunity429Response | null,
