...
export type RequirementWithRelationshipsAiProcessingStateEnum =
  (typeof RequirementWithRelationshipsAiProcessingStateEnum)[keyof typeof RequirementWithRelationshipsAiProcessingStateEnum];
...
export type RequirementWithRelationshipsStatusEnum =
  (typeof RequirementWithRelationshipsStatusEnum)[keyof typeof RequirementWithRelationshipsStatusEnum];

/**
 * Check if a given object implements the RequirementWithRelationships interface.
 */
export function instanceOfRequirementWithRelationships(
  value: object,
): value is RequirementWithRelationships {
...
export function RequirementWithRelationshipsFromJSON(
  json: any,
): RequirementWithRelationships {
  return RequirementWithRelationshipsFromJSONTyped(json, false);
}

export function RequirementWithRelationshipsFromJSONTyped(
  json: any,
...
export function RequirementWithRelationshipsToJSON(
  json: any,
): RequirementWithRelationships {
  return RequirementWithRelationshipsToJSONTyped(json, false);
}

export function RequirementWithRelationshipsToJSONTyped(
  value?: RequirementWithRelationships | null,
