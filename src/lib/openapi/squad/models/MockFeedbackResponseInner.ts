...
export type MockFeedbackResponseInnerTypeEnum =
  (typeof MockFeedbackResponseInnerTypeEnum)[keyof typeof MockFeedbackResponseInnerTypeEnum];

/**
 * Check if a given object implements the MockFeedbackResponseInner interface.
 */
export function instanceOfMockFeedbackResponseInner(
  value: object,
): value is MockFeedbackResponseInner {
...
export function MockFeedbackResponseInnerFromJSON(
  json: any,
): MockFeedbackResponseInner {
  return MockFeedbackResponseInnerFromJSONTyped(json, false);
}

export function MockFeedbackResponseInnerFromJSONTyped(
  json: any,
...
export function MockFeedbackResponseInnerToJSON(
  json: any,
): MockFeedbackResponseInner {
  return MockFeedbackResponseInnerToJSONTyped(json, false);
}

export function MockFeedbackResponseInnerToJSONTyped(
  value?: MockFeedbackResponseInner | null,
