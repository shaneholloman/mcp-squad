 ...
 */
export function instanceOfProcessTextProxy200Response(
  value: object,
): value is ProcessTextProxy200Response {
  if (!("data" in value) || value["data"] === undefined) return false;
  return true;
}

export function ProcessTextProxy200ResponseFromJSON(
  json: any,
): ProcessTextProxy200Response {
  return ProcessTextProxy200ResponseFromJSONTyped(json, false);
}

export function ProcessTextProxy200ResponseFromJSONTyped(
  json: any,
...
export function ProcessTextProxy200ResponseToJSON(
  json: any,
): ProcessTextProxy200Response {
  return ProcessTextProxy200ResponseToJSONTyped(json, false);
}

export function ProcessTextProxy200ResponseToJSONTyped(
  value?: ProcessTextProxy200Response | null,
