...
export type FeedbackSentimentCategoryEnum =
  (typeof FeedbackSentimentCategoryEnum)[keyof typeof FeedbackSentimentCategoryEnum];
...
export function FeedbackToJSONTyped(
  value?: Feedback | null,
