...
export type MetricTypeEnum =
  (typeof MetricTypeEnum)[keyof typeof MetricTypeEnum];
...
export type MetricTargetOperatorEnum =
  (typeof MetricTargetOperatorEnum)[keyof typeof MetricTargetOperatorEnum];
...
export type MetricTargetDirectionEnum =
  (typeof MetricTargetDirectionEnum)[keyof typeof MetricTargetDirectionEnum];
...
export type MetricPeriodTypeEnum =
  (typeof MetricPeriodTypeEnum)[keyof typeof MetricPeriodTypeEnum];
...
export type MetricPeriodValueEnum =
  (typeof MetricPeriodValueEnum)[keyof typeof MetricPeriodValueEnum];
  ...
  return {
    ...
    timeseries:
      json["timeseries"] == null
        ? undefined
        : (json["timeseries"] as Array<any>).map(
            MetricTimeseriesPointOutputFromJSON,
          ),
  ...
  return {
    ...
    timeseries:
      value["timeseries"] == null
        ? undefined
        : (value["timeseries"] as Array<any>).map(
            MetricTimeseriesPointOutputToJSON,
          ),
