...
export type NotionIntegrationIntegrationIdEnum =
  (typeof NotionIntegrationIntegrationIdEnum)[keyof typeof NotionIntegrationIntegrationIdEnum];

/**
 * Check if a given object implements the NotionIntegration interface.
 */
export function instanceOfNotionIntegration(
  value: object,
): value is NotionIntegration {
...
export function NotionIntegrationFromJSONTyped(
  json: any,
...
export function NotionIntegrationToJSONTyped(
  value?: NotionIntegration | null,
