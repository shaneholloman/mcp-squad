...
import {
    ...
    PrioritiseSolutionsResponseFromJSON,
    PrioritiseSolutionsResponseToJSON,
...
export class DefaultApi extends runtime.BaseAPI {
     ...
     */
    async organisationsOrgIdWorkspacesWorkspaceIdSolutionsPrioritisePostRaw(requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPrioritisePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PrioritiseSolutionsResponse>> {
        if (requestParameters['orgId'] == null) {
            throw new runtime.RequiredError(
                'orgId',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => PrioritiseSolutionsResponseFromJSON(jsonValue));
    }
     ...
     * Prioritise solutions
     */
    async organisationsOrgIdWorkspacesWorkspaceIdSolutionsPrioritisePost(requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPrioritisePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PrioritiseSolutionsResponse> {
        const response = await this.organisationsOrgIdWorkspacesWorkspaceIdSolutionsPrioritisePostRaw(requestParameters, initOverrides);
        return await response.value();
    }
