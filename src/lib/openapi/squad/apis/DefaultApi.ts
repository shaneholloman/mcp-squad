...
export class DefaultApi extends runtime.BaseAPI {
   ...
   */
  async manageOpportunityRelationshipsRaw(
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/opportunities/{opportunityId}/relationships/{action}`
          .replace(
            `{${"orgId"}}`,
          ...
          .replace(
            `{${"opportunityId"}}`,
            encodeURIComponent(String(requestParameters["opportunityId"])),
          )
          .replace(
            `{${"action"}}`,
        ...
        body: OpportunityRelationshipsPayloadToJSON(
          requestParameters["opportunityRelationshipsPayload"],
        ),
      },
      initOverrides,
    );
   ...
   * Manage opportunity relationships
   */
  async manageOpportunityRelationships(
    requestParameters: ManageOpportunityRelationshipsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
    await this.manageOpportunityRelationshipsRaw(
      requestParameters,
      initOverrides,
    );
  }
   ...
   */
  async manageOutcomeRelationshipsRaw(
    requestParameters: ManageOutcomeRelationshipsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/outcomes/{outcomeId}/relationships/{action}`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
          ...
          .replace(
            `{${"outcomeId"}}`,
            encodeURIComponent(String(requestParameters["outcomeId"])),
          )
          .replace(
            `{${"action"}}`,
            encodeURIComponent(String(requestParameters["action"])),
        ...
        headers: headerParameters,
        query: queryParameters,
        body: OutcomeRelationshipsPayloadToJSON(
          requestParameters["outcomeRelationshipsPayload"],
        ),
      },
      initOverrides,
    );
   ...
   * Manage outcome relationships
   */
  async manageOutcomeRelationships(
    requestParameters: ManageOutcomeRelationshipsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
   ...
   */
  async manageRequirementRelationshipsRaw(
    requestParameters: ManageRequirementRelationshipsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/requirements/{requirementId}/relationships/{action}`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
          ...
          .replace(
            `{${"requirementId"}}`,
            encodeURIComponent(String(requestParameters["requirementId"])),
          )
          .replace(
            `{${"action"}}`,
            encodeURIComponent(String(requestParameters["action"])),
        ...
        headers: headerParameters,
        query: queryParameters,
        body: RequirementRelationshipsPayloadToJSON(
          requestParameters["requirementRelationshipsPayload"],
        ),
      },
      initOverrides,
    );
   ...
   * Manage requirement relationships
   */
  async manageRequirementRelationships(
    requestParameters: ManageRequirementRelationshipsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
    await this.manageRequirementRelationshipsRaw(
      requestParameters,
      initOverrides,
    );
  }
   ...
   */
  async manageSolutionRelationshipsRaw(
    requestParameters: ManageSolutionRelationshipsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/solutions/{solutionId}/relationships/{action}`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
          ...
          .replace(
            `{${"solutionId"}}`,
            encodeURIComponent(String(requestParameters["solutionId"])),
          )
          .replace(
            `{${"action"}}`,
            encodeURIComponent(String(requestParameters["action"])),
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SolutionRelationshipsPayloadToJSON(
          requestParameters["solutionRelationshipsPayload"],
        ),
      },
      initOverrides,
    );
   ...
   * Manage solution relationships
   */
  async manageSolutionRelationships(
    requestParameters: ManageSolutionRelationshipsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
   ...
   */
  async onboardPostRaw(
    requestParameters: OnboardPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<OnboardingResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      OnboardingResponseFromJSON(jsonValue),
    );
  }
  ...
  async onboardPost(
    ...
    const response = await this.onboardPostRaw(
      requestParameters,
      initOverrides,
    );
   ...
   * List organisations
   */
  async organisationsGetRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<OrganisationsGet200Response>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      OrganisationsGet200ResponseFromJSON(jsonValue),
    );
  }
   ...
   * List organisations
   */
  async organisationsGet(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsGet200Response> {
   ...
   * Delete organisation
   */
  async organisationsOrgIdDeleteRaw(
    requestParameters: OrganisationsOrgIdDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<OrganisationsOrgIdDelete200Response>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}`.replace(
          `{${"orgId"}}`,
          encodeURIComponent(String(requestParameters["orgId"])),
        ),
        method: "DELETE",
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      OrganisationsOrgIdDelete200ResponseFromJSON(jsonValue),
    );
  }
   ...
   * Delete organisation
   */
  async organisationsOrgIdDelete(
    requestParameters: OrganisationsOrgIdDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdDelete200Response> {
    const response = await this.organisationsOrgIdDeleteRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async organisationsOrgIdGetRaw(
    requestParameters: OrganisationsOrgIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<OrganisationsPost200Response>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      OrganisationsPost200ResponseFromJSON(jsonValue),
    );
  }
   ...
   * Get organisation by ID
   */
  async organisationsOrgIdGet(
    requestParameters: OrganisationsOrgIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsPost200Response> {
    const response = await this.organisationsOrgIdGetRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async organisationsOrgIdOnboardPutRaw(
    requestParameters: OrganisationsOrgIdOnboardPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<OnboardingResponse>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/onboard`.replace(
          `{${"orgId"}}`,
          encodeURIComponent(String(requestParameters["orgId"])),
        ),
        method: "PUT",
        headers: headerParameters,
        query: queryParameters,
        body: OnboardingUpdatePayloadToJSON(
          requestParameters["onboardingUpdatePayload"],
        ),
      },
      initOverrides,
    );
   ...
   * Update an existing organization, recreate workspace and outcomes
   */
  async organisationsOrgIdOnboardPut(
    requestParameters: OrganisationsOrgIdOnboardPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OnboardingResponse> {
    const response = await this.organisationsOrgIdOnboardPutRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * Update organisation
   */
  async organisationsOrgIdPutRaw(
    requestParameters: OrganisationsOrgIdPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<OrganisationsPost200Response>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: UpdateOrganisationPayloadToJSON(
          requestParameters["updateOrganisationPayload"],
        ),
      },
      initOverrides,
    );
   ...
   * Update organisation
   */
  async organisationsOrgIdPut(
    requestParameters: OrganisationsOrgIdPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsPost200Response> {
    const response = await this.organisationsOrgIdPutRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async organisationsOrgIdStatusGetRaw(
    requestParameters: OrganisationsOrgIdStatusGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<OrganisationsOrgIdStatusGet200Response>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/status`.replace(
          `{${"orgId"}}`,
          encodeURIComponent(String(requestParameters["orgId"])),
        ),
        method: "GET",
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      OrganisationsOrgIdStatusGet200ResponseFromJSON(jsonValue),
    );
  }
   ...
   * Get organization status
   */
  async organisationsOrgIdStatusGet(
    requestParameters: OrganisationsOrgIdStatusGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdStatusGet200Response> {
    const response = await this.organisationsOrgIdStatusGetRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * List workspaces
   */
  async organisationsOrgIdWorkspacesGetRaw(
    requestParameters: OrganisationsOrgIdWorkspacesGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<OrganisationsOrgIdWorkspacesGet200Response>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces`.replace(
          `{${"orgId"}}`,
          encodeURIComponent(String(requestParameters["orgId"])),
        ),
        method: "GET",
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      OrganisationsOrgIdWorkspacesGet200ResponseFromJSON(jsonValue),
    );
  }
   ...
   * List workspaces
   */
  async organisationsOrgIdWorkspacesGet(
    requestParameters: OrganisationsOrgIdWorkspacesGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesGet200Response> {
    const response = await this.organisationsOrgIdWorkspacesGetRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async organisationsOrgIdWorkspacesPostRaw(
    requestParameters: OrganisationsOrgIdWorkspacesPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<OrganisationsOrgIdWorkspacesPost200Response>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: CreateWorkspacePayloadToJSON(
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      OrganisationsOrgIdWorkspacesPost200ResponseFromJSON(jsonValue),
    );
  }
   ...
   * Create new workspace
   */
  async organisationsOrgIdWorkspacesPost(
    requestParameters: OrganisationsOrgIdWorkspacesPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesPost200Response> {
    const response = await this.organisationsOrgIdWorkspacesPostRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * Delete workspace
   */
  async organisationsOrgIdWorkspacesWorkspaceIdDeleteRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdDelete200Response>
  > {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
   ...
   * Delete workspace
   */
  async organisationsOrgIdWorkspacesWorkspaceIdDelete(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdDelete200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdDeleteRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
  ...
  async organisationsOrgIdWorkspacesWorkspaceIdFeedbackDocumentPostRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<CreateFeedbackDocumentResponse>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/feedback-document`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
        ...
        headers: headerParameters,
        query: queryParameters,
        body: CreateFeedbackDocumentPayloadToJSON(
          requestParameters["createFeedbackDocumentPayload"],
        ),
      },
      initOverrides,
    );
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      CreateFeedbackDocumentResponseFromJSON(jsonValue),
    );
  }
   ...
   * Upload feedback document
   */
  async organisationsOrgIdWorkspacesWorkspaceIdFeedbackDocumentPost(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackDocumentPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<CreateFeedbackDocumentResponse> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdFeedbackDocumentPostRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   * Delete feedback
   */
  async organisationsOrgIdWorkspacesWorkspaceIdFeedbackFeedbackIdDeleteRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackFeedbackIdDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackFeedbackIdDelete200Response>
  > {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/feedback/{feedbackId}`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
   ...
   * Delete feedback
   */
  async organisationsOrgIdWorkspacesWorkspaceIdFeedbackFeedbackIdDelete(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackFeedbackIdDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackFeedbackIdDelete200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdFeedbackFeedbackIdDeleteRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
  ...
  async organisationsOrgIdWorkspacesWorkspaceIdFeedbackFeedbackIdGetRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackFeedbackIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackPost200Response>
  > {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
   ...
   * Get feedback by ID
   */
  async organisationsOrgIdWorkspacesWorkspaceIdFeedbackFeedbackIdGet(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackFeedbackIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackPost200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdFeedbackFeedbackIdGetRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   * List feedback
   */
  async organisationsOrgIdWorkspacesWorkspaceIdFeedbackGetRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<FeedbackArrayResponse>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/feedback`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      FeedbackArrayResponseFromJSON(jsonValue),
    );
  }
   ...
   * List feedback
   */
  async organisationsOrgIdWorkspacesWorkspaceIdFeedbackGet(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<FeedbackArrayResponse> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdFeedbackGetRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   * Create new feedback
   */
  async organisationsOrgIdWorkspacesWorkspaceIdFeedbackPostRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackPostOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackPost200Response>
  > {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackPostRequestToJSON(
          requestParameters[
            "organisationsOrgIdWorkspacesWorkspaceIdFeedbackPostRequest"
          ],
        ),
   ...
   * Create new feedback
   */
  async organisationsOrgIdWorkspacesWorkspaceIdFeedbackPost(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackPostOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackPost200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdFeedbackPostRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   */
  async organisationsOrgIdWorkspacesWorkspaceIdFeedbackProcessPostRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackProcessPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/feedback/process`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
   ...
   * Process Unprocessed Feedback
   */
  async organisationsOrgIdWorkspacesWorkspaceIdFeedbackProcessPost(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdFeedbackProcessPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
    await this.organisationsOrgIdWorkspacesWorkspaceIdFeedbackProcessPostRaw(
      requestParameters,
      initOverrides,
    );
  }
   ...
   * Get workspace by ID
   */
  async organisationsOrgIdWorkspacesWorkspaceIdGetRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<OrganisationsOrgIdWorkspacesPost200Response>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
   ...
   * Get workspace by ID
   */
  async organisationsOrgIdWorkspacesWorkspaceIdGet(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesPost200Response> {
    const response = await this.organisationsOrgIdWorkspacesWorkspaceIdGetRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async organisationsOrgIdWorkspacesWorkspaceIdKnowledgeBaseDocumentsFileNameDeleteRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdKnowledgeBaseDocumentsFileNameDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/knowledge-base-documents/{fileName}`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
   ...
   * Delete knowledge base document
   */
  async organisationsOrgIdWorkspacesWorkspaceIdKnowledgeBaseDocumentsFileNameDelete(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdKnowledgeBaseDocumentsFileNameDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
    await this.organisationsOrgIdWorkspacesWorkspaceIdKnowledgeBaseDocumentsFileNameDeleteRaw(
      requestParameters,
      initOverrides,
    );
  }
  ...
  async organisationsOrgIdWorkspacesWorkspaceIdKnowledgeBaseDocumentsGetRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdKnowledgeBaseDocumentsGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<KnowledgeBaseDocumentListResponse>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/knowledge-base-documents`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      KnowledgeBaseDocumentListResponseFromJSON(jsonValue),
    );
  }
   ...
   * List knowledge base documents
   */
  async organisationsOrgIdWorkspacesWorkspaceIdKnowledgeBaseDocumentsGet(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdKnowledgeBaseDocumentsGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<KnowledgeBaseDocumentListResponse> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdKnowledgeBaseDocumentsGetRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   */
  async organisationsOrgIdWorkspacesWorkspaceIdKnowledgeBaseDocumentsPostRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdKnowledgeBaseDocumentsPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<KnowledgeBaseDocumentUploadResponse>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: KnowledgeBaseDocumentUploadPayloadToJSON(
          requestParameters["knowledgeBaseDocumentUploadPayload"],
        ),
      },
      initOverrides,
    );
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      KnowledgeBaseDocumentUploadResponseFromJSON(jsonValue),
    );
  }
   ...
   * Upload knowledge base document
   */
  async organisationsOrgIdWorkspacesWorkspaceIdKnowledgeBaseDocumentsPost(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdKnowledgeBaseDocumentsPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<KnowledgeBaseDocumentUploadResponse> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdKnowledgeBaseDocumentsPostRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   */
  async organisationsOrgIdWorkspacesWorkspaceIdKnowledgeGetRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdKnowledgeGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<KnowledgeArrayResponse>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/knowledge`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      KnowledgeArrayResponseFromJSON(jsonValue),
    );
  }
   ...
   * List all pieces of knowledge
   */
  async organisationsOrgIdWorkspacesWorkspaceIdKnowledgeGet(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdKnowledgeGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<KnowledgeArrayResponse> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdKnowledgeGetRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
  ...
  async organisationsOrgIdWorkspacesWorkspaceIdKnowledgeKnowledgeIdDeleteRaw(
    ...
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdKnowledgeKnowledgeIdDelete200Response>
  > {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/knowledge/{knowledgeId}`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
  ...
  async organisationsOrgIdWorkspacesWorkspaceIdKnowledgeKnowledgeIdDelete(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdKnowledgeKnowledgeIdDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdKnowledgeKnowledgeIdDelete200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdKnowledgeKnowledgeIdDeleteRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   */
  async organisationsOrgIdWorkspacesWorkspaceIdKnowledgeKnowledgeIdGetRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdKnowledgeKnowledgeIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<SingleKnowledgeResponse>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      SingleKnowledgeResponseFromJSON(jsonValue),
    );
  }
   ...
   * Get a piece of knowledge by ID
   */
  async organisationsOrgIdWorkspacesWorkspaceIdKnowledgeKnowledgeIdGet(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdKnowledgeKnowledgeIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<SingleKnowledgeResponse> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdKnowledgeKnowledgeIdGetRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   */
  async organisationsOrgIdWorkspacesWorkspaceIdKnowledgeKnowledgeIdPutRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdKnowledgeKnowledgeIdPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<SingleKnowledgeResponse>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: UpdateKnowledgePayloadToJSON(
          requestParameters["updateKnowledgePayload"],
        ),
      },
      initOverrides,
    );
   ...
   * Update a piece of knowledge
   */
  async organisationsOrgIdWorkspacesWorkspaceIdKnowledgeKnowledgeIdPut(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdKnowledgeKnowledgeIdPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<SingleKnowledgeResponse> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdKnowledgeKnowledgeIdPutRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   */
  async organisationsOrgIdWorkspacesWorkspaceIdKnowledgePostRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdKnowledgePostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<SingleKnowledgeResponse>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: CreateKnowledgePayloadToJSON(
          requestParameters["createKnowledgePayload"],
        ),
      },
      initOverrides,
    );
   ...
   * Create a new piece of knowledge
   */
  async organisationsOrgIdWorkspacesWorkspaceIdKnowledgePost(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdKnowledgePostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<SingleKnowledgeResponse> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdKnowledgePostRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
  ...
  async organisationsOrgIdWorkspacesWorkspaceIdMockFeedbackPostRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdMockFeedbackPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdMockFeedbackPost200Response>
  > {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/mock-feedback`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
   ...
   * Generate mock feedback
   */
  async organisationsOrgIdWorkspacesWorkspaceIdMockFeedbackPost(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdMockFeedbackPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdMockFeedbackPost200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdMockFeedbackPostRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
  ...
  async organisationsOrgIdWorkspacesWorkspaceIdOpportunitiesGetRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<OpportunityArrayResponse>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/opportunities`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      OpportunityArrayResponseFromJSON(jsonValue),
    );
  }
   ...
   * List opportunities
   */
  async organisationsOrgIdWorkspacesWorkspaceIdOpportunitiesGet(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdOpportunitiesGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OpportunityArrayResponse> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdOpportunitiesGetRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   * Delete opportunity
   */
  async organisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdDeleteRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdDelete200Response>
  > {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/opportunities/{opportunityId}`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
  ...
  async organisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdDelete(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdDelete200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdDeleteRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   */
  async organisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdFeedbackMarkAllSeenPostRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdFeedbackMarkAllSeenPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/opportunities/{opportunityId}/feedback/mark-all-seen`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
   ...
   * Mark all opportunity feedback as seen
   */
  async organisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdFeedbackMarkAllSeenPost(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdFeedbackMarkAllSeenPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
    await this.organisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdFeedbackMarkAllSeenPostRaw(
      requestParameters,
      initOverrides,
    );
  }
  ...
  async organisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdGenerateSolutionsPostRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdGenerateSolutionsPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/opportunities/{opportunityId}/generate-solutions`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
   ...
   * Generate solutions for an opportunity
   */
  async organisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdGenerateSolutionsPost(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdGenerateSolutionsPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
    await this.organisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdGenerateSolutionsPostRaw(
      requestParameters,
      initOverrides,
    );
  }
   ...
   */
  async organisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdGetRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<OpportunityResponse>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      OpportunityResponseFromJSON(jsonValue),
    );
  }
  ...
  async organisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdGet(
    ...
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdGetRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
  ...
  async organisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdPutRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<OpportunityResponse>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: UpdateOpportunityPayloadToJSON(
          requestParameters["updateOpportunityPayload"],
        ),
      },
      initOverrides,
    );
  ...
  async organisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdPut(
    ...
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdOpportunitiesOpportunityIdPutRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
  ...
  async organisationsOrgIdWorkspacesWorkspaceIdOpportunitiesPostRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdOpportunitiesPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<OpportunityResponse>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: CreateOpportunityPayloadToJSON(
          requestParameters["createOpportunityPayload"],
        ),
      },
      initOverrides,
    );
   ...
   * Create new opportunity
   */
  async organisationsOrgIdWorkspacesWorkspaceIdOpportunitiesPost(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdOpportunitiesPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OpportunityResponse> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdOpportunitiesPostRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   * List all outcomes
   */
  async organisationsOrgIdWorkspacesWorkspaceIdOutcomesGetRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGet200Response>
  > {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/outcomes`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
   ...
   * List all outcomes
   */
  async organisationsOrgIdWorkspacesWorkspaceIdOutcomesGet(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesGet200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdOutcomesGetRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
  ...
  async organisationsOrgIdWorkspacesWorkspaceIdOutcomesOutcomeIdDeleteRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesOutcomeIdDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesOutcomeIdDelete200Response>
  > {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/outcomes/{outcomeId}`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
   ...
   * Delete an outcome
   */
  async organisationsOrgIdWorkspacesWorkspaceIdOutcomesOutcomeIdDelete(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesOutcomeIdDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesOutcomeIdDelete200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdOutcomesOutcomeIdDeleteRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   */
  async organisationsOrgIdWorkspacesWorkspaceIdOutcomesOutcomeIdGetRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesOutcomeIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesPost200Response>
  > {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
   ...
   * Get an outcome by ID
   */
  async organisationsOrgIdWorkspacesWorkspaceIdOutcomesOutcomeIdGet(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesOutcomeIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesPost200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdOutcomesOutcomeIdGetRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
  ...
  async organisationsOrgIdWorkspacesWorkspaceIdOutcomesOutcomeIdPutRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesOutcomeIdPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesPost200Response>
  > {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: UpdateOutcomePayloadToJSON(
          requestParameters["updateOutcomePayload"],
        ),
      },
      initOverrides,
    );
   ...
   * Update an outcome
   */
  async organisationsOrgIdWorkspacesWorkspaceIdOutcomesOutcomeIdPut(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesOutcomeIdPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesPost200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdOutcomesOutcomeIdPutRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   */
  async organisationsOrgIdWorkspacesWorkspaceIdOutcomesPostRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesPost200Response>
  > {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: CreateOutcomePayloadToJSON(
          requestParameters["createOutcomePayload"],
        ),
      },
      initOverrides,
    );
   ...
   * Create a new outcome
   */
  async organisationsOrgIdWorkspacesWorkspaceIdOutcomesPost(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdOutcomesPost200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdOutcomesPostRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   * Update workspace
   */
  async organisationsOrgIdWorkspacesWorkspaceIdPutRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<OrganisationsOrgIdWorkspacesPost200Response>> {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: UpdateWorkspacePayloadToJSON(
          requestParameters["updateWorkspacePayload"],
        ),
      },
      initOverrides,
    );
   ...
   * Update workspace
   */
  async organisationsOrgIdWorkspacesWorkspaceIdPut(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesPost200Response> {
    const response = await this.organisationsOrgIdWorkspacesWorkspaceIdPutRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * List requirements
   */
  async organisationsOrgIdWorkspacesWorkspaceIdRequirementsGetRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsGet200Response>
  > {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/requirements`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
   ...
   * List requirements
   */
  async organisationsOrgIdWorkspacesWorkspaceIdRequirementsGet(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsGet200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdRequirementsGetRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   */
  async organisationsOrgIdWorkspacesWorkspaceIdRequirementsPostRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsPost200Response>
  > {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
   ...
   * Create new requirement
   */
  async organisationsOrgIdWorkspacesWorkspaceIdRequirementsPost(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsPost200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdRequirementsPostRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
  ...
  async organisationsOrgIdWorkspacesWorkspaceIdRequirementsRequirementIdDeleteRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsRequirementIdDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsRequirementIdDelete200Response>
  > {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/requirements/{requirementId}`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
   ...
   * Delete requirement
   */
  async organisationsOrgIdWorkspacesWorkspaceIdRequirementsRequirementIdDelete(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsRequirementIdDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsRequirementIdDelete200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdRequirementsRequirementIdDeleteRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   * Get requirement by ID
   */
  async organisationsOrgIdWorkspacesWorkspaceIdRequirementsRequirementIdGet(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsRequirementIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsPost200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdRequirementsRequirementIdGetRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   * Update requirement
   */
  async organisationsOrgIdWorkspacesWorkspaceIdRequirementsRequirementIdPutRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsRequirementIdPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsPost200Response>
  > {
  ...
  async organisationsOrgIdWorkspacesWorkspaceIdRequirementsRequirementIdPut(
    ...
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdRequirementsRequirementIdPutRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   * List solutions
   */
  async organisationsOrgIdWorkspacesWorkspaceIdSolutionsGetRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsGet200Response>
  > {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/solutions`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
   ...
   * List solutions
   */
  async organisationsOrgIdWorkspacesWorkspaceIdSolutionsGet(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsGet200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdSolutionsGetRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   * Create new solution
   */
  async organisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPost200Response>
  > {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: CreateSolutionPayloadToJSON(
          requestParameters["createSolutionPayload"],
        ),
      },
      initOverrides,
    );
   ...
   * Create new solution
   */
  async organisationsOrgIdWorkspacesWorkspaceIdSolutionsPost(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPost200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdSolutionsPostRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
  ...
  async organisationsOrgIdWorkspacesWorkspaceIdSolutionsSolutionIdDeleteRaw(
    ...
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsSolutionIdDelete200Response>
  > {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/solutions/{solutionId}`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
   ...
   * Delete solution
   */
  async organisationsOrgIdWorkspacesWorkspaceIdSolutionsSolutionIdDelete(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsSolutionIdDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsSolutionIdDelete200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdSolutionsSolutionIdDeleteRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   * Get solution by ID
   */
  async organisationsOrgIdWorkspacesWorkspaceIdSolutionsSolutionIdGet(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsSolutionIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPost200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdSolutionsSolutionIdGetRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
  ...
  async organisationsOrgIdWorkspacesWorkspaceIdSolutionsSolutionIdPutRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsSolutionIdPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPost200Response>
  > {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: UpdateSolutionPayloadToJSON(
          requestParameters["updateSolutionPayload"],
        ),
      },
      initOverrides,
    );
   ...
   * Update solution
   */
  async organisationsOrgIdWorkspacesWorkspaceIdSolutionsSolutionIdPut(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsSolutionIdPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdSolutionsPost200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdSolutionsSolutionIdPutRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   */
  async organisationsOrgIdWorkspacesWorkspaceIdTestProxyPostRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdTestProxyPostOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdTestProxyPost200Response>
  > {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/test-proxy`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
        ...
        headers: headerParameters,
        query: queryParameters,
        body: OrganisationsOrgIdWorkspacesWorkspaceIdTestProxyPostRequestToJSON(
          requestParameters[
            "organisationsOrgIdWorkspacesWorkspaceIdTestProxyPostRequest"
          ],
        ),
   ...
   * Process text through AI proxy
   */
  async organisationsOrgIdWorkspacesWorkspaceIdTestProxyPost(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdTestProxyPostOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdTestProxyPost200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdTestProxyPostRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   * List topics
   */
  async organisationsOrgIdWorkspacesWorkspaceIdTopicsGetRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdTopicsGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdTopicsGet200Response>
  > {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/topics`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
   ...
   * List topics
   */
  async organisationsOrgIdWorkspacesWorkspaceIdTopicsGet(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdTopicsGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdTopicsGet200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdTopicsGetRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   * Create new topic
   */
  async organisationsOrgIdWorkspacesWorkspaceIdTopicsPostRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdTopicsPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdTopicsPost200Response>
  > {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
   ...
   * Create new topic
   */
  async organisationsOrgIdWorkspacesWorkspaceIdTopicsPost(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdTopicsPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdTopicsPost200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdTopicsPostRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   * Delete topic
   */
  async organisationsOrgIdWorkspacesWorkspaceIdTopicsTopicIdDeleteRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdTopicsTopicIdDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdTopicsTopicIdDelete200Response>
  > {
    if (requestParameters["orgId"] == null) {
      throw new runtime.RequiredError(
        "orgId",
    ...
    const response = await this.request(
      {
        path: `/organisations/{orgId}/workspaces/{workspaceId}/topics/{topicId}`
          .replace(
            `{${"orgId"}}`,
            encodeURIComponent(String(requestParameters["orgId"])),
          )
   ...
   * Delete topic
   */
  async organisationsOrgIdWorkspacesWorkspaceIdTopicsTopicIdDelete(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdTopicsTopicIdDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdTopicsTopicIdDelete200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdTopicsTopicIdDeleteRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   * Get topic by ID
   */
  async organisationsOrgIdWorkspacesWorkspaceIdTopicsTopicIdGetRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdTopicsTopicIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdTopicsPost200Response>
  > {
   ...
   * Get topic by ID
   */
  async organisationsOrgIdWorkspacesWorkspaceIdTopicsTopicIdGet(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdTopicsTopicIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdTopicsPost200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdTopicsTopicIdGetRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   * Update topic
   */
  async organisationsOrgIdWorkspacesWorkspaceIdTopicsTopicIdPutRaw(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdTopicsTopicIdPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdTopicsPost200Response>
  > {
   ...
   * Update topic
   */
  async organisationsOrgIdWorkspacesWorkspaceIdTopicsTopicIdPut(
    requestParameters: OrganisationsOrgIdWorkspacesWorkspaceIdTopicsTopicIdPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsOrgIdWorkspacesWorkspaceIdTopicsPost200Response> {
    const response =
      await this.organisationsOrgIdWorkspacesWorkspaceIdTopicsTopicIdPutRaw(
        requestParameters,
        initOverrides,
      );
    return await response.value();
   ...
   */
  async organisationsPostRaw(
    requestParameters: OrganisationsPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<OrganisationsPost200Response>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: CreateOrganisationPayloadToJSON(
          requestParameters["createOrganisationPayload"],
        ),
      },
      initOverrides,
    );
   ...
   * Create new organisation
   */
  async organisationsPost(
    requestParameters: OrganisationsPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<OrganisationsPost200Response> {
    const response = await this.organisationsPostRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async v1RequirementsReadyGetRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<
    runtime.ApiResponse<OrganisationsOrgIdWorkspacesWorkspaceIdRequirementsGet200Response>
  > {
