...
export interface AuthenticationApiInterface {
     ...
     */
    v1WhoamiGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<V1WhoamiGet200Response>>;

    /**
     * Returns the ID and name of the authenticated user\'s organization and workspace. This is only callable by an API key which is workspace scoped.
     * Retrieve authenticated user\'s organization and workspace information
     */
    v1WhoamiGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1WhoamiGet200Response>;
